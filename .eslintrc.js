...
const rules = {
    ...
    // You should never use var. Use 'let' or 'const' instead
    'no-var': 'error',
    ...
    // 3.1 Use the object literal syntax for object creation.
    'no-new-object': 'error',
     ...
     *   returning an expression without side effects, following 8.2.
     */
